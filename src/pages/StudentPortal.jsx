...
const StudentPortal = () => {
    ...
    const getTotalAmount = () => {
        return cart.reduce((total, item) => {
            const price =
                item.size && item.product.sizes?.[item.size]
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600">
                        Browse products from all canteen stalls and place your
                        order
                    </p>
                </div>
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    ...
                                    showToast({
                                        ...
                                        description: `Order placed successfully! Total: ₹${getTotalAmount().toFixed(
                                            2
                                        )}`,
                                        type: "success",
                                    });
                    ...
                    {[
                        {
                            id: 1,
                            name: "Yurish Food",
                            cuisine: "Juice center",
                            rating: 4.5,
                            prepTime: "10–15 min",
                            starProducts: ["Mango Shake", "Fresh Lime"],
                            crowdFav: "Mango Shake",
                            image: "/banner1.png",
                            menu: yurishMenu,
                        },
                        {
                            id: 2,
                            name: "Evergreen",
                            cuisine: "Juice & Health Drinks",
                            rating: 4.6,
                            prepTime: "5–10 min",
                            starProducts: ["ABC Booster", "Rose milk"],
                            crowdFav: "ABC Booster",
                            image: "/banner2.png",
                            menu: evergreenMenu,
                        },
                        {
                            ...
                            rating: 4.7,
                            prepTime: "5–10 min",
                            starProducts: ["Loaded Chicken", "Tender Strips"],
                            crowdFav: "Loaded Chicken",
                            image: "/banner3.png",
                            menu: zingerMenu,
                        },
                    ].map((vendor) => (
