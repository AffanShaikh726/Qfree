        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {userTypes.map((userType, index) => (
            <Card key={index} className="relative">
              <div className={`absolute inset-0 bg-gradient-to-br ${userType.gradient} opacity-5 group-hover:opacity-10 transition-all duration-300 pointer-events-none z-0`}></div>
              ...
              <CardContent className="space-y-6 relative z-10">
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    console.log('Navigating to', userType.path);
